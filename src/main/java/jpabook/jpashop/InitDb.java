...
public class InitDb {
    ...
    @PostConstruct
    public void init() {
        initService.dbInit1(); //dbInit()의 코드를 그대로 가져와서 사용해도 된다고 생각할 수 있지만
        initService.dbInit2();  // 스프링의 라이프사이클 때문에 문제가 발생할 수 있으며 분리해서 사용하는것이 좋다.
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            Book book2 = createBook("JPA2 BOOK", 20000, 101);
            em.persist(book2);
